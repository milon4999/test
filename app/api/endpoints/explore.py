...
EXPLORE_SOURCES = [
    ...
    ExploreSourceResponse(
        baseUrl="https://mydesi10.com/",
        nickname="MyDesi HD",
        favicon="https://mydesi10.com/wp-content/uploads/2026/09/MyDesi-HD.png",
        accentColor="#E91E63",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://mydesi10.com/?s={query}",
        sourceId="mydesi10",
        disable=False,
        pageSize=30,
    ),
    ExploreSourceResponse(
        baseUrl="https://www.mydesi2.fit/",
        nickname="MyDesi2",
        favicon="https://www.mydesi2.fit/wp-content/uploads/2025/02/logo.jpg",
        accentColor="#1D73C0",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.mydesi2.fit/?s={query}",
        sourceId="mydesi2",
        disable=False,
        pageSize=30,
    ),
    ExploreSourceResponse(
        baseUrl="https://mydesi.com.co/",
        nickname="MyDesi",
        favicon="https://mydesi.com.co/logo.png",
        accentColor="#C2185B",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://mydesi.com.co/search/{query}",
        sourceId="mydesico",
        disable=False,
        pageSize=32,
    ),
    ExploreSourceResponse(
        baseUrl="https://mydesi.rest/",
        nickname="MyDesi Rest",
        favicon="https://tdn.mydesi.rest/wp-content/uploads/2026/02/cropped-mydesi-favicon-32x32-1.png",
        accentColor="#E91E63",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://mydesi.rest/?s={query}",
        sourceId="mydesirest",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        baseUrl="https://mydesi.sbs/",
        nickname="MyDesi",
        favicon="https://cdn.mydesi.sbs/wp-content/uploads/2026/08/cropped-mydesi-favicon-32x32-1.png",
        accentColor="#E91E63",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://mydesi.sbs/?s={query}",
        sourceId="mydesisbs",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        baseUrl="https://viralchut.com/",
        nickname="Viralchut",
        favicon="https://viralchut.com/wp-content/uploads/2026/02/cropped-cropped-cropped-d503ebf9-d759-4df6-9f76-cb061b4b0b5f.png",
        accentColor="#AD1457",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://viralchut.com/?s={query}",
        sourceId="viralchut",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://viralmms.com/?s={query}",
        sourceId="viralmms",
        disable=False,
        pageSize=30,
    ),
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://xanimeporn.com/?s={query}",
        sourceId="xanimeporn",
        disable=False,
        pageSize=24,
    ),
    ...
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.mykamababa.com/?s={query}",
        sourceId="kamababa",
        disable=False,
        pageSize=30,
    ),
    ...
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://mydesi2.com.co/?s={query}",
        sourceId="mydesimms",
        disable=False,
        pageSize=30,
    ),
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://p4455.com/?s={query}",
        sourceId="p4455",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        baseUrl="https://www.85ro.com/en/",
        nickname="85PO",
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.85ro.com/en/search/{query}/",
        sourceId="po85",
        disable=False,
        pageSize=60,
    ),
    ...
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://sxyland.com/?s={query}",
        sourceId="sxyland",
        disable=False,
        pageSize=32,
    ),
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://camcaps.tv/search/videos/{query}",
        sourceId="camcaps",
        disable=False,
        pageSize=30,
    ),
    ExploreSourceResponse(
        ...
        nickname="KoreanPornMovie",
        favicon="https://koreanpornmovie.com/wp-content/uploads/2020/01/cropped-koreanpornmovie-favicon-32x32.png",
        accentColor="#DB0159",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://koreanpornmovie.com/?s={query}",
        sourceId="koreanpornmovie",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        ...
        nickname="FullPorner",
        favicon="https://static.xiaoshenke.net/img/favicon.png?v=2",
        accentColor="#E91E63",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://fullporner.com/search?q={query}",
        sourceId="fullporner",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        ...
        nickname="SuperPorn",
        favicon="https://www.superporn.com/apple-touch-icon.png",
        accentColor="#05FF00",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.superporn.com/search?q={query}",
        sourceId="superporn",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        ...
        nickname="Siska",
        favicon="https://siska.tv/favicon.ico",
        accentColor="#00ADEE",
        category="porn",
        isVerified=False,
        hasCategories=True,
    ...
    ExploreSourceResponse(
        ...
        nickname="PornDos",
        favicon="https://www.porndos.com/favicon.ico",
        accentColor="#D11315",
        category="porn",
        isVerified=False,
        hasCategories=True,
    ...
    ExploreSourceResponse(
        baseUrl="https://joysporn.io/",
        nickname="JoysPorn",
        favicon="https://joysporn.io/favicon.png",
        accentColor="#29B6F6",
        category="porn",
        isVerified=False,
        hasCategories=True,
    ...
    ExploreSourceResponse(
        baseUrl="https://fullxcinema.com/",
        nickname="FullXCinema",
        favicon="https://fullxcinema.com/favicon.ico",
        accentColor="#3779F7",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://fullxcinema.com/?s={query}",
        sourceId="fullxcinema",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        baseUrl="https://film-adult.video/en/",
        nickname="FilmAdult",
        favicon="https://film-adult.video/en/templates/HDFilmAdult4K/images/favicon.svg",
        accentColor="#0F1015",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://film-adult.video/en/index.php?do=search&subaction=search&story={query}",
        sourceId="filmadult",
        disable=False,
        pageSize=15,
    ),
    ExploreSourceResponse(
        baseUrl="https://pornhits.tv/",
        nickname="PornHits",
        favicon="https://cdn.veporn.com/site-favicons/88b454d0-d234-4e11-9efd-c7ec38f87dab.png",
        accentColor="#E63946",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://pornhits.tv/search?q={query}",
        sourceId="pornhits",
        disable=False,
        pageSize=24,
    ),
    ExploreSourceResponse(
        baseUrl="https://pornmz.net/",
        nickname="Pornmz",
        favicon="https://pornmz.net/favicon.ico",
        accentColor="#FF2D55",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://pornmz.net/?s={query}",
        sourceId="pornmz",
        disable=False,
        pageSize=20,
    ),
    ...
    ExploreSourceResponse(
        baseUrl="https://motherlesss.net/",
        nickname="Motherless",
        favicon="https://motherlesss.net/img/favicon.ico",
        accentColor="#212121",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://motherlesss.net/?s={query}",
        sourceId="motherless",
        disable=False,
        pageSize=60,
    ),
    ...
    ExploreSourceResponse(
        baseUrl="https://www.porndish.com/",
        nickname="Porndish",
        favicon="https://www.porndish.com/wp-content/uploads/2022/03/logo.png",
        accentColor="#E0218A",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.porndish.com/?s={query}",
        sourceId="porndish",
        disable=False,
        pageSize=30,
    ),
    ExploreSourceResponse(
        baseUrl="https://w8.mypornerleak.com/",
        nickname="MyPornerLeak",
        favicon="https://mypornerleak.com/wp-content/uploads/favicon-mypornerleak.png",
        accentColor="#E91E63",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://w8.mypornerleak.com/?s={query}",
        sourceId="mypornerleak",
        disable=False,
        pageSize=54,
    ),
    ExploreSourceResponse(
    ...
    ExploreSourceResponse(
        baseUrl="https://sosalkino.city/",
        nickname="Sosalkino",
        favicon="https://sosalkino.city/favicon.ico",
        accentColor="#9C27B0",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://sosalkino.city/search/{query}/",
        sourceId="sosalkino",
        disable=False,
        pageSize=24,
    ),
    ...
    ExploreSourceResponse(
        baseUrl="https://blackporn.tube/",
        nickname="BlackPornTube",
        favicon="https://blackporn.tube/static/images/favicons/favicon-32x32.png",
        accentColor="#8D6E63",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://blackporn.tube/search/1/?s={query}",
        sourceId="blackporntube",
        disable=False,
        pageSize=48,
    ),
    ExploreSourceResponse(
    ...
    ExploreSourceResponse(
        baseUrl="https://hentaihaven.com/",
        nickname="Hentai Haven",
        favicon="https://hentaihaven.com/wp-content/uploads/2023/01/Hentai-Haven-Logo-2.png",
        accentColor="#E91E63",
        category="hentai",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://hentaihaven.com/?s={query}",
