...
async def get_video_info(url: str, api_base_url: str = "http://localhost:8000") -> dict:
    ...
    elif joysporn.can_handle(host):
        scraper_module = joysporn
    elif fullxcinema.can_handle(host):
        scraper_module = fullxcinema
    elif filmadult.can_handle(host):
        scraper_module = filmadult
    elif pornhits.can_handle(host):
        scraper_module = pornhits
    elif pornmz.can_handle(host):
        scraper_module = pornmz
    elif fpoxxx.can_handle(host):
        scraper_module = fpoxxx
    elif watchporn.can_handle(host):
        scraper_module = watchporn
    elif helloporn.can_handle(host):
        scraper_module = helloporn
    elif homoxxx.can_handle(host):
        scraper_module = homoxxx
    elif perfectgirls.can_handle(host):
        scraper_module = perfectgirls
    elif exeporn.can_handle(host):
        scraper_module = exeporn
    elif xozilla.can_handle(host):
        scraper_module = xozilla
    elif xmilf.can_handle(host):
        scraper_module = xmilf
    elif hdzog.can_handle(host):
        scraper_module = hdzog
    elif analdin.can_handle(host):
        scraper_module = analdin
    elif nuvid.can_handle(host):
        scraper_module = nuvid
    elif p4455.can_handle(host):
        scraper_module = p4455
    elif mydesi2.can_handle(host):
        scraper_module = mydesi2
    elif mydesi10.can_handle(host):
        scraper_module = mydesi10
    elif mydesico.can_handle(host):
        scraper_module = mydesico
    elif mydesirest.can_handle(host):
        scraper_module = mydesirest
    elif mydesisbs.can_handle(host):
        scraper_module = mydesisbs
    elif viralchut.can_handle(host):
        scraper_module = viralchut
    elif viralmms.can_handle(host):
        scraper_module = viralmms
    elif xanimeporn.can_handle(host):
        scraper_module = xanimeporn
    elif vrsmash.can_handle(host):
        scraper_module = vrsmash
    elif porndish.can_handle(host):
        scraper_module = porndish
    elif mypornerleak.can_handle(host):
        scraper_module = mypornerleak
    elif momvids.can_handle(host):
        scraper_module = momvids
    else:
        raise HTTPException(
            status_code=400,
            detail=f"Unsupported host: {host}. Supported: xnxx, xhamster, xvideos, masa49 (.org/.com/.cam), pornhub, youporn, redtube, beeg, spankbang, fapnut, pornxp, hqporner, xxxparodyhd, urshort.live (embed), pornwex, tube8, pornhat, brazzpw, gosexpod, watcherotic, rou.video, 51cg/chigua, oppai.stream, xmoviesforyou.com, tnaflix.com, hornysimp.com, pimpbunny.com, hentaiser.app, bollywoodmaal.com, viralkand.com, blowjobs.pro, blackporn24.com, blackporn.tube, lesbianporn8.net, milfporn8.net, indianporn365.xyz, mmsbro.com, mykamababa.com, desimms2.site, desiporn.one, thotsporn.com, leakedamateurporn.xyz, zeenite.com, uncutmazaa.com (uncutmaza.com/.cc rewrite), mydesi2.com.co, mydesi2.dev, mydesi2.fit, mydesimms.watch, p4455.com, 85po.com (mirrors: 85ro.com, 85po.net), mydesi10.com, mydesi.com.co, mydesi.rest, mydesi.sbs, viralchut.com, viralmms.com, xanimeporn.com, cosxplay.com, memojav.com, hohoj.tv, ggjav.com, porn87.com, goodav17.com, kanav.ad, missav.ai, jable.tv, 94mt.cc, bindasmood.com, eporner.com, dotmaal.com, uncutmasti.com, zmaal.net, ulluwebseries.one, desithothub.com, motherless.com, youjizz.com, pornone.com, 3movs.com, porndig.com, porndish.com, hotmovs.tube, shemalez.com, txxx.com, ok.xxx, pornhoarder.tw, yesporn.vip, justporn.com, porngo.com, 1porn.tv, thepornbang.com, letsporn.com, teamskeettube.com, sosalkino.guru, tubepornclassic.com, xxxdan.com, pornxxx.tube, sxyprn.com, latestpornvideo.com, youperv.com, tube.perverzija.com, bigwank.com, sp2026.dev (91porn), 91porn.com, 9p9.xyz, sxyland.com, camcaps.tv, koreanpornmovie.com, fullporner.com, superporn.com, siska.tv, shyfap.net, hdporn92.com, porndos.com, joysporn.io, fullxcinema.com, film-adult.video, pornhits.tv, pornmz.net, fpo.xxx, watchporn.to, hello.porn, homo.xxx, perfectgirls.xxx, exeporn.net, xozilla.com, xmilf.com, hdzog.com, analdin.com, nuvid.club, vrsmash.com, mypornerleak.com, momvids.com"
        )
...
async def get_stream_url(url: str, quality: str = "default", api_base_url: str = "http://localhost:8000") -> dict:
    ...
    if ("pornhub.com" in parsed_url.netloc.lower() or 
        ...
        "mykamababa.com" in parsed_url.netloc.lower() or
        "kamababa1.com" in parsed_url.netloc.lower() or
        ...
        "mydesi2.fit" in parsed_url.netloc.lower() or
        "myd-cdn.com" in parsed_url.netloc.lower() or
        "mydesimms.watch" in parsed_url.netloc.lower() or
        "mydesix10.watch" in parsed_url.netloc.lower() or
        "mydesi.rest" in parsed_url.netloc.lower() or
        "mydesi.sbs" in parsed_url.netloc.lower() or
        "85ro.com" in parsed_url.netloc.lower() or
        "85po.net" in parsed_url.netloc.lower() or
        ...
        "vstor.top" in parsed_url.netloc.lower() or
        "fullxcinema.com" in parsed_url.netloc.lower() or
        "freevidco.com" in parsed_url.netloc.lower() or
        ...
        "playmogo.com" in parsed_url.netloc.lower() or
        "pornhits.tv" in parsed_url.netloc.lower() or
        "veporn.com" in parsed_url.netloc.lower() or
        "pornmz.net" in parsed_url.netloc.lower() or
        "video.twimg.com" in parsed_url.netloc.lower() or
        ...
        "motherlesss.net" in parsed_url.netloc.lower() or
        ...
        "cdnawm.com" in parsed_url.netloc.lower() or
        "fpo.xxx" in parsed_url.netloc.lower() or
        "www.fpo.xxx" in parsed_url.netloc.lower() or
        "watchporn.to" in parsed_url.netloc.lower() or
        "www.watchporn.to" in parsed_url.netloc.lower() or
        "zload.cc" in parsed_url.netloc.lower() or
        "hello.porn" in parsed_url.netloc.lower() or
        "static.hello.porn" in parsed_url.netloc.lower() or
        "homo.xxx" in parsed_url.netloc.lower() or
        "static.homo.xxx" in parsed_url.netloc.lower() or
        "perfectgirls.xxx" in parsed_url.netloc.lower() or
        "static.perfectgirls.xxx" in parsed_url.netloc.lower() or
        "exeporn.net" in parsed_url.netloc.lower() or
        "xozilla.com" in parsed_url.netloc.lower() or
        "vcdn.xozilla.com" in parsed_url.netloc.lower() or
        "xmilf.com" in parsed_url.netloc.lower() or
        "ahcdn.xmilf.com" in parsed_url.netloc.lower() or
        "hdzog.com" in parsed_url.netloc.lower() or
        "hdzog.ahcdn.com" in parsed_url.netloc.lower() or
        "analdin.com" in parsed_url.netloc.lower() or
        "vcdn.analdin.com" in parsed_url.netloc.lower() or
        "p4455.com" in parsed_url.netloc.lower() or
        "mydesi2.fit" in parsed_url.netloc.lower() or
        "myd-cdn.com" in parsed_url.netloc.lower() or
        "mydesi10.com" in parsed_url.netloc.lower() or
        "mydesi.com.co" in parsed_url.netloc.lower() or
        "mydesi.rest" in parsed_url.netloc.lower() or
        "mydesi.sbs" in parsed_url.netloc.lower() or
        "cdn.aamchor.com" in parsed_url.netloc.lower() or
        "viralchut.com" in parsed_url.netloc.lower() or
        "cdn.desisex.store" in parsed_url.netloc.lower() or
        "viralmms.com" in parsed_url.netloc.lower() or
        "vms.viralmms.net" in parsed_url.netloc.lower() or
        "xanimeporn.com" in parsed_url.netloc.lower() or
        "nuvid.club" in parsed_url.netloc.lower() or
        "nuvid.com" in parsed_url.netloc.lower() or
        "gcdn.nuvid.club" in parsed_url.netloc.lower() or
        "vkuser.net" in parsed_url.netloc.lower() or
        "privatehost.com" in parsed_url.netloc.lower() or
        "vrsmash.com" in parsed_url.netloc.lower() or
        "porndish.com" in parsed_url.netloc.lower() or
        "mypornerleak.com" in parsed_url.netloc.lower() or
        "momvids.com" in parsed_url.netloc.lower()):
        ...
        per_stream_format_keys = (
            ...
            or "mykamababa.com" in host_l
            or "kamababa1.com" in host_l
            ...
            or "mydesi2.fit" in host_l
            or "myd-cdn.com" in host_l
            or "mydesimms.watch" in host_l
            or "mydesix10.watch" in host_l
            or "mydesi.rest" in host_l
            or "mydesi.sbs" in host_l
            or "85ro.com" in host_l
            or "85po.net" in host_l
            ...
            or "vstor.top" in host_l
            or "fullxcinema.com" in host_l
            or "freevidco.com" in host_l
            ...
            or "playmogo.com" in host_l
            or "pornhits.tv" in host_l
            or "veporn.com" in host_l
            or "pornmz.net" in host_l
            or "video.twimg.com" in host_l
            ...
            or "fpo.xxx" in host_l
            or "www.fpo.xxx" in host_l
            or "watchporn.to" in host_l
            or "www.watchporn.to" in host_l
            or "zload.cc" in host_l
            or "hello.porn" in host_l
            or "static.hello.porn" in host_l
            or "homo.xxx" in host_l
            or "static.homo.xxx" in host_l
            or "perfectgirls.xxx" in host_l
            or "static.perfectgirls.xxx" in host_l
            or "exeporn.net" in host_l
            or "xozilla.com" in host_l
            or "vcdn.xozilla.com" in host_l
            or "xmilf.com" in host_l
            or "ahcdn.xmilf.com" in host_l
            or "hdzog.com" in host_l
            or "hdzog.ahcdn.com" in host_l
            or "analdin.com" in host_l
            or "vcdn.analdin.com" in host_l
            or "p4455.com" in host_l
            or "mydesi2.fit" in host_l
            or "myd-cdn.com" in host_l
            or "mydesi10.com" in host_l
            or "mydesi.com.co" in host_l
            or "mydesi.rest" in host_l
            or "mydesi.sbs" in host_l
            or "cdn.aamchor.com" in host_l
            or "viralchut.com" in host_l
            or "cdn.desisex.store" in host_l
            or "viralmms.com" in host_l
            or "vms.viralmms.net" in host_l
            or "xanimeporn.com" in host_l
            or "nuvid.club" in host_l
            or "nuvid.com" in host_l
            or "gcdn.nuvid.club" in host_l
            or "vkuser.net" in host_l
            or "privatehost.com" in host_l
            or "porndish.com" in host_l
            or "mypornerleak.com" in host_l
            or "momvids.com" in host_l
        )
