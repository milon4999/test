...
BASE_URL = "https://viralchut.com/"
CANONICAL_HOST = "viralchut.com"
...
def can_handle(host: str) -> bool:
    ...
    return h in _SUPPORTED_HOSTS or h.endswith(".viralchut.com")
...
def _clean_title(title: str | None) -> Optional[str]:
    ...
    for suffix in (
        ...
        " - Viralchut.com",
        " | Viralchut.com",
        " - Viralchut - Watch Latest Desi Leaked Sex Videos",
        " | Viralchut - Watch Latest Desi Leaked Sex Videos",
    ):
...
def _normalize_video_href(href: str) -> Optional[str]:
    ...
    if _normalize_host(parsed.netloc) not in _SUPPORTED_HOSTS:
        return None
    if any(x in parsed.path.lower() for x in ("/wp-content/", "/wp-json/", "/wp-admin/", "/tag/", "/tags/", "/category/", "/categories/", "/page/", "/author/", "/feed/", "/contact", "/privacy", "/dmca", "/18-u-s-c-2257", "/terms-of-use", "/about-us", "/content-complaint")):
        return None
    if parsed.query:
        return None
