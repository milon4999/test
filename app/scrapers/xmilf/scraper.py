...
SITE = "xmilf.com"
BASE = f"https://{SITE}"
SITE_ALIASES = frozenset({"xmilf.com", "www.xmilf.com", "tn.xmilf.com", "ahcdn.xmilf.com"})
...
def can_handle(host: str) -> bool:
    ...
    if h.startswith("www."):
        h = h[4:]
    return h in SITE_ALIASES or h.endswith(".xmilf.com")
...
def _clean_title(title: str | None) -> Optional[str]:
    ...
    for suffix in (" | xmilf.com", " - xmilf.com", " | XMILF", " - XMILF"):
